...
[imf_el,ort_el,nbits_el] = emd_online(1:length(y),y,[0.05,0.5,20,100],4,0,0);
...
f = scf(4);f.color_map = jetcolormap(64);
subplot(221)

grayplot(1:size(rs,2),1:128,rs(1:128,:)');
...
subplot(222)
grayplot(1:size(rs1,2),1:128,rs1(1:128,:)');
// set(gca,'YTick',[]);set(gca,'XTick',[])
xlabel('time')
ylabel('frequency')
title('mode #1')
...
subplot(223)
grayplot(1:size(rs2,2),1:128,rs2(1:128,:)');
// set(gca,'YTick',[]);set(gca,'XTick',[])
xlabel('time')
ylabel('frequency')
title('mode #2')
...
subplot(224)
grayplot(1:size(rs3,2),1:128,rs3(1:128,:)');
// set(gca,'YTick',[]);set(gca,'XTick',[])
xlabel('time')
ylabel('frequency')
title('mode #3')
