function [IMF,NB_ITERATIONS]=cemdc2_fix(T,X,NB_ITERATIONS,MAX_IMFS,NDIRS);
//  bivariate Empirical Mode Decomposition, second algorithm
//  Calling Sequence
// [IMF,NB_ITERATIONS]=cemdc2_fix(T,X);
// [IMF,NB_ITERATIONS]=cemdc2_fix([],X);
// [IMF,NB_ITERATIONS]=cemdc2_fix(T,X,NB_ITERATIONS);
// [IMF,NB_ITERATIONS]=cemdc2_fix(T,X,NB_ITERATIONS,MAX_IMFS);
...
//   Description
//
// cemdc2_fix computes bivariate EMD, second algorithm [1] with NB_ITERATONS sifting
