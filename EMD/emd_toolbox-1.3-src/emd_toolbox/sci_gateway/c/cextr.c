...
void c_extr(double x[], COMPLEX_T z[], double phi,int n,extrema_t *ex) {
    int cour;
...
void c_boundary_conditions(double x[],COMPLEX_T z[],double phi,int n,extrema_t *ex) {
    int cour,nbsym;
    #ifdef C99_OK
    COMPLEX_T eiphi;
    #endif
